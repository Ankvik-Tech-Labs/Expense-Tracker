...
if snapshots_df.empty:
    st.warning("No historical data available. Upload data for multiple months to see trends.")
    st.stop()
...
table_df = display_df[[
    'month', 'total_value', 'total_invested', 'total_pl', 'total_pl_pct',
    'stocks_value', 'mf_value', 'mom_change', 'mom_change_pct'
]].copy()

table_df.columns = [
    'Month', 'Total Value', 'Invested', 'P&L', 'P&L %',
    'Stocks', 'Mutual Funds', 'MoM Change', 'MoM %'
]
